...
* 1.1   2011.04.09  Sahuc Guillaume 	view sd.c
* 1.2	2013.04.20  Sahuc Guillaume		add function SD_Read16BitsBmpFile
******************************************************************************/                                                                        
...
extern const UINT8* SdCardDetect;
extern const UINT8* FileFound;
extern const UINT8* FileCreate;
...
//#define SD_PRESENT   PTAD_PTAD2
//#define _SD_PRESENT  PTADD_PTADD2
...
enum
{
	...
	NO_SD_CARD,
	BAD_FILE_FORMAT,
	INCOMPLETE_BUFFER_READ,
	UNSUPPORTED_COMPRESSION,
	NO_MORE_FREE_CLUSTER
};

extern const UINT8* Error[];
...
/* Prototypes */
UINT8 SD_Init(void);
UINT8 SD_SendCommand(UINT8,UINT8,UINT8);
...
void SD_WriteFile(UINT8*);
void SD_WriteLogFile(void);
void SD_SysHalt(void);
