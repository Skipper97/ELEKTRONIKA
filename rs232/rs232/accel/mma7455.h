...
//i2c settings
#define MMA7455_I2CFLEURYPATH "../i2c/i2cmaster.h" //define the path to i2c fleury lib
...
#define MMA7455_GETATTITUDE 1 //enable this to get attitude pitch and roll
...
#define MMA7455_CALRANGEVALX 71 //62.5
#define MMA7455_CALRANGEVALY 72.5 //64.6
#define MMA7455_CALRANGEVALZ 62.5
#define MMA7455_CALOFFSETX -0.02
#define MMA7455_CALOFFSETY 0.16
#define MMA7455_CALOFFSETZ -0.05
#endif
